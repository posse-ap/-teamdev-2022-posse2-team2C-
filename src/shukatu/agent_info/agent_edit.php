...
<body>
    ...
    <div class="right_page_container">
        <h1 class="agent-detail__tittle"><?php print $rec["company_name"]; ?>の情報を修正します。</h1>
                ...
                <div class="agent_info_reg_wrapper">
                    ...
                    <div class="checkbox_area">
                        ...
                        while (true) {
                            ...
                            <div class="checkbox">
                                <input type="checkbox" class="agent-edit__tag-existence" value="<?php echo $rec_2["tag_code"] ?>">
                                <?php echo $rec_2["tag_name"]; ?>
                            </div>
                        <?php } ?>
                    </div>

    ...
    <div class="display_agent">
        ...
        <div class="right_page_container">
            <div class="agent-detail__wrapper">
                <h1 class="agent-detail__tittle">エージェント詳細・掲載状態 <br> エージェントコード： <?php print $rec["agent_id"]; ?></h1>
                <ul class="agent-detail__info-wrapper">
                    <div class="agent-detail__tittle">詳細ページ記載内容</div>
                    <li class="agent-detail__info">エージェント名：<?php print $rec["company_name"]; ?></li>
                ...
                <ul class="agent-detail__tag-wrapper">
                    <div class="agent-detail__tittle">タグ</div>
                    <div class="agent-detail__tag-area">
                        <div class="agent-detail__tag-name">
                            <?php
                            while (true) {
                        ...
                        <div class="agent-detail__tag-value">
                            <?php
                            for ($i = 1; $i < 16; $i++) {
                                if ($rec["tag_" . $i] === 0) { ?>
